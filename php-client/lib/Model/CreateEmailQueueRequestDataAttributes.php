<?php
/**
 * CreateEmailQueueRequestDataAttributes
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateEmailQueueRequestDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmailQueueRequestDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEmailQueue_request_data_attributes';
    ...
    */
     ...
     * Sets to
     *
     * @param string|null $to Recipient of the email
     *
     * @return self
     */
     ...
     * Sets body_html
     *
     * @param string|null $body_html HTML body content of the email
     *
     * @return self
     */
     ...
     * Sets body_text
     *
     * @param string|null $body_text Plain text body content of the email
     *
     * @return self
     */
